...
public class Incident {
	...
	// SLGT - Add support for social media
	/**
	 * Get the social media attached to the report
	 * 
	 * @return The link to the social media
	 */
	public String getSocialMedia() {
		return socialmedia;
	}

	// SLGT - Add support for menus
	/**
	 * Get the menu attached to the report
	 * 
	 * @return The link to the social media
	 */
	...
	// SLGT - Add support for menus
	/**
	 * Set the menu link for the location
	 * 
	 * @param menu
	...
	// SLGT - Add support for social media
	/**
	 * Set the social media link for the location
	 * 
	 * @param menu
