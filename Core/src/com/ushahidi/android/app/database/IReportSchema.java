...
public interface IReportSchema {
	...
	public static final String INCIDENT_SOCIALMEDIA = "incident_socialmedia";
	
	public static final String INCIDENT_MENU = "incident_menu";
	...
	public static final String[] INCIDENTS_COLUMNS = new String[] { ID,
			INCIDENT_ID, INCIDENT_TITLE, INCIDENT_DESC, INCIDENT_SOCIALMEDIA, INCIDENT_MENU, INCIDENT_DATE,
