...
public interface IOfflineReportSchema {
    ...
    public static final String SOCIALMEDIA = "incident_socialmedia";
    
    public static final String MENU = "incident_menu";
    ...
    public static final String[] OFFLINE_REPORT_COLUMNS = new String[] {
            ID, TITLE, DESCRIPTION, SOCIALMEDIA, MENU, DATE, HOUR, MINUTE, AMPM, CATEGORIES, LOCATION_NAME, LATITUDE,
    ...
    public static final String OFFLINE_REPORT_TABLE_CREATE = "CREATE TABLE IF NOT EXISTS "
            ...
            + " TEXT NOT NULL, " + DESCRIPTION + " TEXT, " + SOCIALMEDIA + " TEXT, " + MENU + " TEXT, " + DATE + " DATE NOT NULL, " + HOUR
