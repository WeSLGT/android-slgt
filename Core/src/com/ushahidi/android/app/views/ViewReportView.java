...
public class ViewReportView extends com.ushahidi.android.app.views.View {
	...
	private ListView listSocialMedia;
	...
	public ViewReportView(ViewGroup activity, Context context) { 
		...
		menu = (TextView) activity.findViewById(R.id.menu);
		socialmedia = (TextView) activity.findViewById(R.id.socialmedia);
	...
	public String getSocialMedia() {
		return this.socialmedia.getText().toString();
	}
