...
public class AddReportView extends View {
	...
	public EditText mSocialMedia;
	
	public EditText mMenu;
	...
	public AddReportView(Activity activity) {
		...
		mSocialMedia = (EditText) activity.findViewById(R.id.social_media);
		mMenu = (EditText) activity.findViewById(R.id.menu);
